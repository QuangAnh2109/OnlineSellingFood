                      ...
                      <form action="accountdetail" method="post" >
                        <div class="row">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <input required="" class="form-control" name="phoneNumber" type="text" />
                          </div>
                          <div class="form-group col-md-12">
                            <label>Birth Year <span class="required">*</span></label>
                            <input required="" class="form-control" name="birthYear" type="date" />
                          </div>
                      ...
                      <form method="post" name="enq">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <input required="" class="form-control" name="oPassword" type="password" />
                          </div>
                          <div class="form-group col-md-12">
