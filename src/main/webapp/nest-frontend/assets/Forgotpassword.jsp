        ...
        <div class="col-xl-8 col-lg-10 col-md-12 m-auto">
          <div class="row">
            <div class="col-lg-6 pr-30 d-none d-lg-block">
              <img class="border-radius-15" src="imgs/page/login-1.png" alt="" />
            </div>
            <div class="col-lg-6 col-md-8">
              <div class="login_wrap widget-taber-content background-white">
                <div class="padding_eight_all bg-white">
                  ...
                  <form  method="post" action="Forgotpassword" onsubmit="return validateForm()">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="position-relative newsletter-inner">
            ...
            <img src="imgs/banner/banner-13.png" alt="newsletter" />
          </div>
        </div>
      </div>
    </div>
...
<script src="js/shop.js?v=4.0"></script>
</div>
</body>
</html>
