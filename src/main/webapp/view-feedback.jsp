...
<script type="text/javascript">
    function doDelete(customerID) {
        if (confirm("Are you sure to delete feedback with customerID=" + customerID)) {
            window.location = "viewfeedback?cutomerID=" +customerID;
        }
    }
</script>
<head>
...
<main class="main-wrap">
    ...
    <section class="content-main">
        <div class="content-header">
            <h2 class="content-title">View Feedback</h2>
<%--            <div>--%>
                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${list}"  var="l">
                            ...
                            <tr>
                                ...
                                <td>${l.time}</td>
                                <td class="text-end">
                                    <a href="#" onclick="doDelete(${l.customerID})" class="btn btn-sm btn-brand rounded font-sm mt-15">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
